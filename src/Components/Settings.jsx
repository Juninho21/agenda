            ...
            <div className="calendar" style={{ width: '100%', maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', height: 'auto' }}>
                ...
                <div style={{ padding: '2rem' }}>
                    ...
                    <div style={{ marginBottom: '2rem' }}>
                        ...
                        <Link to="/settings/clients" style={{ textDecoration: 'none' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem', background: 'var(--bg-element)', borderRadius: '12px', marginBottom: '1rem', cursor: 'pointer', transition: 'background 0.2s' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    <i className='bx bx-user' style={{ fontSize: '2.4rem', color: 'var(--accent-color)' }}></i>
                                    <span style={{ color: 'var(--text-primary)', fontSize: '1.6rem', fontWeight: '500' }}>Clientes</span>
                                </div>
                                <i className='bx bx-chevron-right' style={{ color: 'var(--text-muted)', fontSize: '2.4rem' }}></i>
                            </div>
                        </Link>
                        ...
                        <Link to="/settings/users" style={{ textDecoration: 'none' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem', background: 'var(--bg-element)', borderRadius: '12px', marginBottom: '1rem', cursor: 'pointer', transition: 'background 0.2s' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    <i className='bx bx-group' style={{ fontSize: '2.4rem', color: 'var(--accent-color)' }}></i>
                                    <span style={{ color: 'var(--text-primary)', fontSize: '1.6rem', fontWeight: '500' }}>Gerenciar Usuários</span>
                                </div>
                                <i className='bx bx-chevron-right' style={{ color: 'var(--text-muted)', fontSize: '2.4rem' }}></i>
                            </div>
                        </Link>

                        <Link to="/settings/quotes" style={{ textDecoration: 'none' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem', background: 'var(--bg-element)', borderRadius: '12px', marginBottom: '1rem', cursor: 'pointer', transition: 'background 0.2s' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    <i className='bx bx-file' style={{ fontSize: '2.4rem', color: 'var(--accent-color)' }}></i>
                                    <span style={{ color: 'var(--text-primary)', fontSize: '1.6rem', fontWeight: '500' }}>Orçamentos</span>
                                </div>
                                <i className='bx bx-chevron-right' style={{ color: 'var(--text-muted)', fontSize: '2.4rem' }}></i>
                            </div>
                        </Link>
